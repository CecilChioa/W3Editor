...
export class Map: public QObject {
  ...
  public:
	...
	void load(const fs::path& path) {
		...
		const auto load_optional_ini = [](const fs::path& path) -> std::optional<ini::INI> {
			if (!hierarchy.file_exists(path)) {
				return std::nullopt;
			}
			return ini::INI(path);
		};
		const auto merge_optional_ini = [](slk::SLK& target, const std::optional<ini::INI>& source, slk::SLK& meta) {
			if (source) {
				target.merge(*source, meta);
			}
		};
		...
		auto units_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(units_slk, load_optional_ini("Units/UnitSkin.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/UnitWeaponsFunc.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/UnitWeaponsSkin.txt"), units_meta_slk);
			...
			merge_optional_ini(units_slk, load_optional_ini("Units/HumanUnitFunc.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/OrcUnitFunc.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/UndeadUnitFunc.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/NightElfUnitFunc.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/NeutralUnitFunc.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/CampaignUnitFunc.txt"), units_meta_slk);

			merge_optional_ini(units_slk, load_optional_ini("Units/HumanUnitStrings.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/OrcUnitStrings.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/UndeadUnitStrings.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/NightElfUnitStrings.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/NeutralUnitStrings.txt"), units_meta_slk);
			merge_optional_ini(units_slk, load_optional_ini("Units/CampaignUnitStrings.txt"), units_meta_slk);
		});
		...
		auto items_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(items_slk, load_optional_ini("Units/ItemSkin.txt"), items_meta_slk);
			merge_optional_ini(items_slk, load_optional_ini("Units/ItemFunc.txt"), items_meta_slk);
			merge_optional_ini(items_slk, load_optional_ini("Units/ItemStrings.txt"), items_meta_slk);
		});
		...
		auto doodads_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(doodads_slk, load_optional_ini("Doodads/DoodadSkins.txt"), doodads_meta_slk);
		...
		auto destructibles_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(destructibles_slk, load_optional_ini("Units/DestructableSkin.txt"), destructibles_meta_slk);
			destructibles_slk.substitute(world_edit_strings, "WorldEditStrings");
		...
		// Load shared files
		const auto ability_skin_ini = load_optional_ini("Units/AbilitySkin.txt");
		const auto ability_skin_strings_ini = load_optional_ini("Units/AbilitySkinStrings.txt");
		const auto human_ability_func_ini = load_optional_ini("Units/HumanAbilityFunc.txt");
		const auto orc_ability_func_ini = load_optional_ini("Units/OrcAbilityFunc.txt");
		const auto undead_ability_func_ini = load_optional_ini("Units/UndeadAbilityFunc.txt");
		const auto night_elf_ability_func_ini = load_optional_ini("Units/NightElfAbilityFunc.txt");
		const auto neutral_ability_func_ini = load_optional_ini("Units/NeutralAbilityFunc.txt");
		const auto item_ability_func_ini = load_optional_ini("Units/ItemAbilityFunc.txt");
		const auto common_ability_func_ini = load_optional_ini("Units/CommonAbilityFunc.txt");
		const auto campaign_ability_func_ini = load_optional_ini("Units/CampaignAbilityFunc.txt");
		const auto human_ability_strings_ini = load_optional_ini("Units/HumanAbilityStrings.txt");
		const auto orc_ability_strings_ini = load_optional_ini("Units/OrcAbilityStrings.txt");
		const auto undead_ability_strings_ini = load_optional_ini("Units/UndeadAbilityStrings.txt");
		const auto night_elf_ability_strings_ini = load_optional_ini("Units/NightElfAbilityStrings.txt");
		const auto neutral_ability_strings_ini = load_optional_ini("Units/NeutralAbilityStrings.txt");
		const auto item_ability_strings_ini = load_optional_ini("Units/ItemAbilityStrings.txt");
		const auto common_ability_strings_ini = load_optional_ini("Units/CommonAbilityStrings.txt");
		const auto campaign_ability_strings_ini = load_optional_ini("Units/CampaignAbilityStrings.txt");
		...
		auto abilities_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(abilities_slk, ability_skin_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, ability_skin_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, human_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, orc_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, undead_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, night_elf_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, neutral_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, item_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, common_ability_func_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, campaign_ability_func_ini, abilities_meta_slk);

			merge_optional_ini(abilities_slk, human_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, orc_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, undead_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, night_elf_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, neutral_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, item_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, common_ability_strings_ini, abilities_meta_slk);
			merge_optional_ini(abilities_slk, campaign_ability_strings_ini, abilities_meta_slk);
		});
		...
		auto upgrade_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(upgrade_slk, ability_skin_ini, upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/UpgradeSkin.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/HumanUpgradeFunc.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/OrcUpgradeFunc.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/UndeadUpgradeFunc.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/NightElfUpgradeFunc.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/NeutralUpgradeFunc.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/CampaignUpgradeFunc.txt"), upgrade_meta_slk);

			merge_optional_ini(upgrade_slk, load_optional_ini("Units/CampaignUpgradeStrings.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/HumanUpgradeStrings.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/NeutralUpgradeStrings.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/NightElfUpgradeStrings.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/OrcUpgradeStrings.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/UndeadUpgradeStrings.txt"), upgrade_meta_slk);
			merge_optional_ini(upgrade_slk, load_optional_ini("Units/UpgradeSkinStrings.txt"), upgrade_meta_slk);
		});
		...
		auto buff_future = std::async(std::launch::async, [&] {
			...
			merge_optional_ini(buff_slk, ability_skin_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, ability_skin_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, human_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, orc_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, undead_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, night_elf_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, neutral_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, item_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, common_ability_func_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, campaign_ability_func_ini, buff_meta_slk);

			merge_optional_ini(buff_slk, human_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, orc_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, undead_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, night_elf_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, neutral_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, item_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, common_ability_strings_ini, buff_meta_slk);
			merge_optional_ini(buff_slk, campaign_ability_strings_ini, buff_meta_slk);
		});
