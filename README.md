# W3Editor
W3Editor is a Warcraft III World Editor (WE) that focuses on speed and ease of use. 
...
[Thread on the Hiveworkshop](https://www.hiveworkshop.com/threads/introducing-W3Editor.303183/)
...
- Edit the terrain
![W3Editor Screenshot](/Screenshots/W3Editor.png)
- Advanced Object Editor
![W3Editor Screenshot](/Screenshots/ObjectEditor.png)
...
See the [releases page](https://github.com/stijnherfst/W3Editor/releases) for binary downloads.
...
1. Clone W3Editor somewhere 
`git clone https://github.com/stijnherfst/W3Editor.git`
...
5. Open Visual Studio as an **Administrator** and using the open folder button to open the W3Editor folder. (**Administrator required** for creating a symbolic link on Windows)
...
Want to help with the development of W3Editor? Below is a list of features that you could implement. You can try one of these or just add something else you feel like W3Editor should have. Any contributions are welcome!

- Being able to change forces/teams
- Changing map sizes/camera bound
- Ramp editing with the terrain palette
- Making W3Editor run faster
- An FDF frame editor
- Text colorizer
